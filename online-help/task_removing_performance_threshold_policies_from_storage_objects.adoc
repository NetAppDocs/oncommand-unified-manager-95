...
a|
Click image:../media/select_dropdown_65_png.gif[] and select *Select all objects on this page*.
a|
All objects of the same type
a|
Click image:../media/select_dropdown_65_png.gif[] and select *Select all objects*.
|===
