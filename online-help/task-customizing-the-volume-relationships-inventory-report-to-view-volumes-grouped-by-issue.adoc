...
. To filter volumes according to the volume relationship health status, select the *Relationship Health* column, and click the image:../media/click-to-filter.gif[] icon.
