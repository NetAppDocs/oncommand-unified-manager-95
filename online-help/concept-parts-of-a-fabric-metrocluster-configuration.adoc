...
image::../media/mcc-hardware-architecture-both-clusters.gif[]
...
image::../media/mcc-hardware-architecture-cluster-a-with-7500n.gif[]
...
image::../media/mcc-hardware-architecture-both-clusters-2-node-fabric.gif[]
...
image::../media/mcc-hardware-architecture-cluster-a-2-node-with-7500n.gif[]
