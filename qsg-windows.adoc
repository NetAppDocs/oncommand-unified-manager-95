...
Microsoft .NET 4.5.2, or greater, must be installed. Unified Manager installs other required third-party packages as part of the installation. If you need more information on the dependent software packages, see the link:../install/concept-requirements-for-installing-unified-manager.html[Requirements for installing Unified Manager].
