---
permalink: health-checker/reference_additional_menu_options.html
sidebar: sidebar
keywords: 
...
+
You can regenerate the server certificate in the Unified Manager GUI by clicking *image:../media/clusterpage_settings_icon.gif[]* > *HTTPS Certificate* > *Regenerate HTTPS Certificate*.
